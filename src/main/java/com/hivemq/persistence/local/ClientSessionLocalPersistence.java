...
public interface ClientSessionLocalPersistence extends LocalPersistence {
     ...
     */
    @NotNull BucketChunkResult<@NotNull Map<String, ClientSession>> getAllClientsChunk(@NotNull PersistenceFilter filter, int bucketIndex, @Nullable String lastClientId, int maxResults);
}
